# This sample uses the native bash functionality for pulling dynamic metadata from a Microsoft Azure VM for incoming reboot events caused by planned maintenance. 
